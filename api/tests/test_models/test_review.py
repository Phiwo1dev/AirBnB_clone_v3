...
class TestReviewDocs(unittest.TestCase):
    """Test to check the documentation and style of Review class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_review(self):
        """Test whether models/review.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_review(self):
        """Test if tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_func_docstrings(self):
        """Test for presence of docstrings in Review methods"""
...
class TestReview(unittest.TestCase):
    ...
    def test_user_id_attr(self):
        """Tests if Review has attr user_id, and it's an empty string"""
        review = Review()
    ...
    def test_str(self):
        """tests if the str method has the correct output"""
        review = Review()
