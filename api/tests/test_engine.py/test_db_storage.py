...
class TestDBStorageDocs(unittest.TestCase):
    """Tests for checking the documentation and style of DBStorage class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_db_storage(self):
        """Test whether models/engine/db_storage.py conforms to PEP8."""
...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        """Tests for db_storage.py module docstring"""
    ...
    def test_db_storage_class_docstring(self):
        """Tests for DBStorage class docstring"""
    ...
    def test_dbs_func_docstrings(self):
        """Tests for presence of docstrings in DBStorage methods"""
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Tests whether get returns specific object, or none"""
